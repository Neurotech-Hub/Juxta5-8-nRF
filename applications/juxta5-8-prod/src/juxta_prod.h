...
#define JUXTA_LOG_SCHEMA "jxta-nor-csv-v3"
#define JUXTA_LOGGING_VERSION 3
...
#define JUXTA_DEFAULT_UPLOAD_PATH "/TEST"
#define JUXTA_DEFAULT_EXPERIMENT "default"
#define JUXTA_DEFAULT_MODE "normal"
